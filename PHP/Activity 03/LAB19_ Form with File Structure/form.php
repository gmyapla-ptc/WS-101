...
<!-- Gender -->
Gender:
    <input type="radio" name="gender" value="Male" required <?php if(isset($_POST['gender']) && $_POST['gender'] == "Male") echo "checked"; ?>> Male
...
<!-- textarea -->
 <textarea name="message" rows="5" cols="30" required><?php echo isset($_POST['message']) ? htmlspecialchars(trim($_POST['message'])) : ''; ?></textarea>
    <br>
...
//L16 AGE     
    ...
    elseif ($_POST["age"] < 1 || $_POST["age"] > 120) {
